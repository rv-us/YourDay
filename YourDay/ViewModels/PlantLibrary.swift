...
struct PlantLibrary {
    static let allPlantBlueprints: [PlantBlueprint] = [
        // Common Plants
        PlantBlueprint(id: "sunflower_c_su", name: "Sunflower", description: "A cheerful flower.", rarity: .common, theme: .summer, initialDaysToGrow: 2, baseValue: 25, assetName: "spring-common0", iconName: "spring-common0"),
        PlantBlueprint(id: "tulip_c_sp", name: "Tulip", description: "A classic spring bulb.", rarity: .common, theme: .spring, initialDaysToGrow: 2, baseValue: 25, assetName: "summer-common0", iconName: "summer-common0"),
        PlantBlueprint(id: "marigold_c_fa", name: "Marigold", description: "Hardy autumn bloom.", rarity: .common, theme: .fall, initialDaysToGrow: 2, baseValue: 25, assetName: "fall-common0", iconName: "fall-common0"),
        PlantBlueprint(id: "pansy_c_wi", name: "Pansy", description: "Resilient winter color.", rarity: .common, theme: .winter, initialDaysToGrow: 2, baseValue: 25, assetName: "winter-common0", iconName: "winter-common0"),
        PlantBlueprint(id: "fern_c_sp", name: "Spring Fern", description: "A lush, green fern unfurling in spring.", rarity: .common, theme: .spring, initialDaysToGrow: 2, baseValue: 25, assetName: "spring-common1", iconName: "spring-common1"),
